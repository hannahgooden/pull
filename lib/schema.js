...
const fields = {
  ...
  pullInterval: Joi.number().integer()
    .description('Number of seconds to wait between checking for upstream changes')
}
...
const ruleSchemaWithDeprecation = Joi.object().keys({
  ...
  pullInterval: fields.pullInterval.default(3600),
